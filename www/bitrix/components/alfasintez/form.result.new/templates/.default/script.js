$( document ).ready(function() {
	...
	$('.alfasintez-call-back-form .alfasintez-question-3 input').attr({placeholder: "Name *",data_only_text:""});
	$('.alfasintez-call-back-form .alfasintez-question-4 input').attr({placeholder: "Phone number *",phone:""});
...
// проверка формы на заполненность////////
    $('body').on('click', '.alfasintez-call-back-form .alfasintez-form-submit', function(event)
    {
        ...
        var $input_1 = $('.alfasintez-call-back-form .alfasintez-question-3 input'),
            $input_2 = $('.alfasintez-call-back-form .alfasintez-question-4 input');
