...
[
	'NAME'   => Loc::getMessage('ALFASINTEZ_CATALOG_PARAMS_HIDE_NOT_AVAILABLE_OFFERS'),
	'TYPE'   => 'CHECKBOX',
	'PARENT' => 'BASE'
];
$arTemplateParameters['SET_TITLE'] =
[
	'NAME'   => Loc::getMessage('ALFASINTEZ_CATALOG_PARAMS_SET_TITLE'),
	'TYPE'   => 'CHECKBOX',
	'PARENT' => 'EXTENDED_SETTINGS'
];
$arTemplateParameters['ADD_SECTIONS_CHAIN'] =
[
	'NAME'   => Loc::getMessage('ALFASINTEZ_CATALOG_PARAMS_ADD_SECTIONS_CHAIN'),
	'TYPE'   => 'CHECKBOX',
	'PARENT' => 'EXTENDED_SETTINGS'
];
$arTemplateParameters['ADD_ELEMENT_CHAIN'] =
[
	'NAME'   => Loc::getMessage('ALFASINTEZ_CATALOG_PARAMS_ADD_ELEMENT_CHAIN'),
	'TYPE'   => 'CHECKBOX',
	'PARENT' => 'EXTENDED_SETTINGS'
];
/** **********************************************************************
 ...
 ******************************* new params ******************************
 ************************************************************************/
$arTemplateParameters['CHAIN_TITLE'] =
[
	'NAME'   => Loc::getMessage('ALFASINTEZ_CATALOG_PARAMS_CHAIN_TITLE'),
	'TYPE'   => 'STRING',
	'PARENT' => 'EXTENDED_SETTINGS'
];
if( count($iblockPropsFile) )
	...
	[
		'NAME'   => Loc::getMessage('ALFASINTEZ_CATALOG_PARAMS_DETAIL_PICTURES_ALT'),
		'TYPE'   => 'LIST',
		'VALUES' => array_merge([0 => Loc::getMessage('ALFASINTEZ_CATALOG_PARAMS_LIST_EMPTY_VALUE')], $iblockPropsFile),
		'PARENT' => 'DETAIL_SETTINGS'
	];
$arTemplateParameters['ASK_FORM_ID'] =
[
	'NAME'   => Loc::getMessage('ALFASINTEZ_CATALOG_PARAMS_ASK_FORM_ID'),
	'TYPE'   => 'STRING',
	'PARENT' => 'DETAIL_SETTINGS'
];
if( $askFormId > 0 )
	...
	[
		'NAME'   => Loc::getMessage('ALFASINTEZ_CATALOG_PARAMS_ASK_FORM_LINK_FIELD_ID'),
		'TYPE'   => 'STRING',
		'PARENT' => 'DETAIL_SETTINGS'
	];